...
# 3. A setter method named score that sets the value of the private
#    property _score. This method should take a single argument for the value
#    and set _score to this value * 10.
